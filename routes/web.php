...
Route::middleware(['auth', 'user'])->prefix('user')->namespace('user')->group(function ()
{
    ...
    Route::get('/buy/product/increase-qty', [BuyController::class, 'increaseQty'])->name('product.buy.increase.qty');
    Route::get('/buy/prodict/decrease-qty', [BuyController::class, 'decreaseQty'])->name('product.buy.decrease.qty');
