                            ...
                            @if ($order->status !== 'canceled')
                                <div class="track">
                                    ...
                                    <div class="step {{ $order->confirm_date ? 'active' : '' }}">
                                        ...
                                        <small
                                            class="text-danger">{{ $order->confirm_date ? Carbon\Carbon::parse($order->confirm_date)->format('D d-m-Y') : '' }}</small>
                                    </div>
                                    <div class="step {{ $order->processing_date ? 'active' : '' }}">
                                        <span class="icon"> <i class="fa fa-shopping-cart"></i> </span>
                                        <span class="text">Order Processing</span>
                                        <small
                                            class="text-danger">{{ $order->processing_date ? Carbon\Carbon::parse($order->processing_date)->format('D d-m-Y') : '' }}</small>
                                    </div>
                                    <div class="step {{ $order->shipped_date ? 'active' : '' }}">
                                        <span class="icon"> <i class="fa fa-truck"></i> </span>
                                        <span class="text">Shipped Order</span>
                                        <small
                                            class="text-danger">{{ $order->shipped_date ? Carbon\Carbon::parse($order->shipped_date)->format('D d-m-Y') : '' }}</small>
                                    </div>
                                    <div class="step {{ $order->picked_date ? 'active' : '' }}">
                                        <span class="icon"> <i class="fa fa-user"></i> </span>
                                        <span class="text">Picked Order</span>
                                        <small
                                            class="text-danger">{{ $order->picked_date ? \Carbon\Carbon::parse($order->picked_date)->format('D d-m-Y') : '' }}</small>
                                    </div>
                                    <div class="step {{ $order->delivered_date ? 'active' : '' }}">
                                        <span class="icon"> <i class="fa fa-hand-lizard-o"></i> </span>
                                        <span class="text">Delivered</span>
                                        <small
                                            class="text-danger">{{ $order->delivered_date ? Carbon\Carbon::parse($order->delivered_date)->format('D d-m-Y') : '' }}</small>
                                    </div>
                                </div>
                            @else
                                <div class="track">
