        ...
        <div class="row row-sm">
            <div class="col-md-12">
                <div class="card pd-10 pd-sm-20">
                    ...
                    <form action="{{ route('product.store') }}" method="POST" class="form-layout"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-show-search" name="brand_id"
                                        ...
                                        @foreach ($brands as $brand)
                                            <option value="{{ $brand->id }}" name="brand">{{ $brand->brand_name_en }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('brand_id')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_name_bn"
                                        value="{{ old('product_name_bn') }}" placeholder="Enter Product Name English">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Product Quantity English<span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="product_quantity_en"
                                        value="{{ old('product_quantity_en') }}"
                                        placeholder="Enter Product Quantity English">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Product Quantity Bangla<span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="product_quantity_bn"
                                        value="{{ old('product_quantity_bn') }}"
                                        placeholder="Enter Product Quantity Bangla">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_tags_en"
                                        value="{{ old('product_tags_en') }}" placeholder="Enter Product Tags English"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_tags_bn"
                                        ...
                                        placeholder="Enter Product Tags Bangla"data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_color_en"
                                        value="{{ old('product_color_en') }}" placeholder="Enter Product Color English"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_color_bn"
                                        value="{{ old('product_color_bn') }}" placeholder="Enter Product Color Bangla"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_size_en"
                                        value="{{ old('product_size_en') }}" placeholder="Enter Product Size English"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_size_bn"
                                        value="{{ old('product_size_bn') }}" placeholder="Enter Product Size Bangla"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Product Weight English<span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="product_weight_en"
                                        value="{{ old('product_weight_en') }}"
                                        placeholder="Enter Product Weight English">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Product Weight Bangla<span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="product_weight_bn"
                                        value="{{ old('product_size_bn') }}" placeholder="Product Weight Bangla">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="selling_price"
                                        value="{{ old('selling_price') }}" placeholder="Enter Product Name Bangla">
                                    @error('selling_price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="discount"
                                        value="{{ old('discount') }}" placeholder="Discount Amount">
                                    @error('discount')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" name="product_thumbnail"
                                        value="{{ old('product_thumbnail') }}" accept="image/*"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label">Prdouct Multiple Image<span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="file" name="product_multiple_image[]"
                                        value="{{ old('product_multiple_image') }}" id="multiple-image" multiple>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Product Short Description English<span
                                            class="tx-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Product Short Description Bangla<span
                                            class="tx-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Product Full Description English<span
                                            class="tx-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Product Full Description Bangla<span
                                            class="tx-danger">*</span></label>
