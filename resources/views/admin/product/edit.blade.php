                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_name_bn"
                                        value="{{ $product->product_name_bn }}" placeholder="Enter Product Name English">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_tags_en"
                                        value="{{ $product->product_tags_en }}" placeholder="Enter Product Tags English"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_color_en"
                                        ...
                                        placeholder="Enter Product Color English" data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_size_en"
                                        value="{{ $product->product_size_en }}" placeholder="Enter Product Size English"
                                        data-role="tagsinput">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_size_bn"
                                        value="{{ $product->product_size_bn }}" placeholder="Enter Product Size Bangla"
                                        data-role="tagsinput">
