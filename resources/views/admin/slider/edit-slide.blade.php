            ...
            <div class="card pd-10 pd-sm-20">
                ...
                <form action="{{route('slider.update',[$slide->id])}}" class="form-layout" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title_en" value="{{$slide->title_en}}" placeholder="Enter Slide Title">
                        @error('title_en')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title_bn" value="{{$slide->title_bn}}" placeholder="Enter Slide Title">
                        @error('title_bn')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="sub_title_en" value="{{$slide->sub_title_en}}" placeholder="Enter Slide Sub Title">
                        @error('sub_title_en')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="sub_title_bn" value="{{$slide->sub_title_bn}}" placeholder="Enter Slide Sub Title">
                        @error('sub_title_bn')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="description_en" class="form-control" id="description" placeholder="Enter Slide Description">{{$slide->description_en}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description_bn" class="form-control" id="description" placeholder="Enter Slide Description">{{$slide->description_bn}}</textarea>
