        ...
        <div class="action">
            <ul class="list-unstyled">
                <li class="add-cart-button btn-group">
                    ...
                    <button onClick="addToCart()" class="btn btn-primary cart-btn" type="button">
...
<button onclick="addToWishList({{ $product->id }})" data-toggle="tooltip" class="btn add-to-wishlist" title=""
...
<li>
    <button data-toggle="tooltip" class="btn compare" title="" data-original-title="Add To Cart"
        onclick="addToCart()">
