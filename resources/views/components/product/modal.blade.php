            ...
            <div class="modal-body  text-center">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <ul class="list-group">
                                <li class="list-group-item">Price : ৳<span class="text-danger discount-price-modal"
                                        style="background: red; border-radius:5px; padding:3px; margin:5px 10px; color: #fff;"></span><span
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group color-group">
                                ...
                                <select name="color" id="color" class="form-control color" style="margin:10px 0;">
                                    <option value="">Select One</option>
                                </select>
                            </div>
                            <div class="form-group size-group">
                                <label for="size"> Select Size:</label>
                                <select name="size" id="size" class="form-control size" style="margin:10px 0;">
                                    <option value="">Select One</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control quantity" value="1" id="quantity"
                                    min="1" name="quantity">
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="modal-product-id" name="product_id" value=""
                                    id="modal-product-id">
                                <button type="submit" class="btn btn-danger product-cart-btn btn-block"
