                        ...
                        <li class="dropdown dropdown-small">
                            @if (Session::get('language') == 'bangla')
                                <a href="#" class="dropdown-toggle" data-hover="dropdown"
                                    data-toggle="dropdown"><span class="value">ভাষা পরিবর্তন করুন </span><b
                                        class="caret"></b></a>
                            @else
                                <a href="#" class="dropdown-toggle" data-hover="dropdown"
                                    data-toggle="dropdown"><span class="value">Change Language </span><b
                                        class="caret"></b></a>
                            @endif
                                                                    ...
                                                                    <ul class="links">
                                                                        @foreach ($subSubCategories as $subSubCategory)
                                                                            @if ($subCategory->id === $subSubCategory->subcategory_id)
                                                                                @if (session()->get('language') == 'bangla')
                                                                                    <li><a
                                                                                            href="{{ route('product.subSubCategory', ['id' => $subSubCategory->id, 'slug' => $subSubCategory->subsubcategory_slug_en]) }}">{{ $subSubCategory->subsubcategory_name_bn }}</a>
                                                                                    </li>
                                                                                @else
                                                                                    <li><a
                                                                                            href="{{ route('product.subSubCategory', ['id' => $subSubCategory->id, 'slug' => $subSubCategory->subsubcategory_slug_en]) }}">{{ $subSubCategory->subsubcategory_name_en }}</a>
                                                                                    </li>
                                                                                @endif
                                                                            @endif
                                                                        @endforeach
