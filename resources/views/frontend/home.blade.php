            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                    ...
                    <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
                        <h3 class="section-title">{{ session()->get('language') == 'bangla' ? 'ধামাকা অফার' : 'hot deals' }}
                        </h3>
                    ...
                    <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                        <h3 class="section-title">
                            {{ session()->get('language') == 'bangla' ? 'স্পেশাল অফার' : 'Special Offer' }}
                        </h3>
                                                    ...
                                                    <div class="row product-micro-row">
                                                        ...
                                                        <div class="col col-xs-5">
                                                            <div class="product-image">
                                                                <div class="image">
                                                                    <a
                                                                        href="{{ route('product.detail', ['id' => $product->id, 'slug' => $product->product_slug_en]) }}">
                                                        ...
                                                        <div class="col col-xs-7">
                                                            <div class="product-info">
                                                                <h3 class="name"><a
                                                                        href="{{ route('product.detail', ['id' => $product->id, 'slug' => $product->product_slug_en]) }}">{{ session()->get('language') == 'bangla' ? $product->product_name_bn : $product->product_name_en }}</a>
                                                                </h3>
                    ...
                    <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                        <h3 class="section-title">
                            {{ session()->get('language') == 'bangla' ? 'স্পেশাল ডিল' : 'Special Deals' }}
                        </h3>
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                                @foreach ($specialOffers as $product)
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                    ...
                    <section class="section featured-product wow fadeInUp">
                        <h3 class="section-title">
                            {{ session()->get('language') == 'bangla' ? 'ফিচার পণ্যসমুহ' : 'Featured products' }}</h3>
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p20.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p21.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p22.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p23.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p24.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p25.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p26.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="#">
                                                                    <img src="assets/frontend/images/products/p27.jpg"
                                                                        alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                            ...
                            <div class="owl-carousel blog-slider custom-carousel">
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image">
                                                <a href="blog.html"><img src="assets/frontend/images/blog-post/post1.jpg"
                                                        alt=""></a>
                                            </div>
                                        </div><!-- /.blog-post-image -->
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image">
                                                <a href="blog.html"><img src="assets/frontend/images/blog-post/post2.jpg"
                                                        alt=""></a>
                                            </div>
                                        </div><!-- /.blog-post-image -->
