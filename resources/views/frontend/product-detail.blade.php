        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <li class='active'><a
                            href="#">{{ session()->get('language') == 'bangla' ? $singleProduct->product_name_bn : $singleProduct->product_name_en }}</a>
                    </li>
                </ul>
                    ...
                    <div class="sidebar-module-container">
                        ...
                        <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
                            <h3 class="section-title">
                                {{ session()->get('language') == 'bangla' ? 'ধামাকা অফার' : 'hot deals' }}
                            </h3>
                        ...
                        <div class="row  wow fadeInUp">
                                        ...
                                        @foreach ($singleProduct->images as $image)
                                            <div class="single-product-gallery-item" id="slide{{ $image->id }}">
                                                <a data-lightbox="image-{{ $image->id }}" data-title="Gallery"
                                                    href="{{ asset($image->product_image_name) }}">
                                                    <img class="img-responsive" alt="{{ $singleProduct->product_name_en }}"
                                                        src="{{ asset($image->product_image_name) }}"
                                                        data-echo="{{ asset($image->product_image_name) }}" />
                                                </a>
                                                ...
                                                <div class="item">
                                                    <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                        ...
                                                        <img class="img-responsive" width="85"
                                                            alt="{{ $singleProduct->product_name_en }}"
                                                            src="{{ asset($image->product_image_name) }}"
                                                            data-echo="{{ asset($image->product_image_name) }}" />
                                                    </a>
                                                </div>
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    <h1 class="name">
                                        {{ session()->get('language') == 'bangla' ? $singleProduct->product_name_bn : $singleProduct->product_name_en }}
                                    </h1>
                                            ...
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    @if ($singleProduct->product_quantity_en != null)
                                                        <span
                                                            class="value">{{ session()->get('language') == 'bangla' ? 'Availability :' : 'In Stock' }}</span>
                                                    @else
                                                        <span
                                                            class="value">{{ session()->get('language') == 'bangla' ? 'Availability :' : 'Out Of Stack Stock' }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div><!-- /.row -->
                                    ...
                                    <div class="price-container info-container m-t-20">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    <span
                                                        class="price">৳{{ session()->get('language') == 'bangla' ? toBanglaNumber($singleProduct->discount_price) : $singleProduct->discount_price }}</span>
                                                    <span
                                                        class="price-strike">৳{{ session()->get('language') == 'bangla' ? toBanglaNumber($singleProduct->selling_price) : $singleProduct->selling_price }}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="quantity-container info-container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    @if (session()->get('language') === 'bangla')
                                                        <div class="form-group">
                                                            <label for="size" class="label">সাইজ নির্বাচন
                                                                করুন:</label>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="cart-quantity">
                                                        <div class="quant-input">
                                                            ...
                                                            <input type="number" value="1" min="1"
                                                                class="quantity unicase-form-control" name="qty">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="hidden" name="product_id" id="product-id"
                                                        class="product-id" value="{{ $singleProduct->id }}">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" onclick="addToCart()">
                                                        <i class="fa fa-shopping-cart inner-right-vs"></i>
                                                        {{ session()->get('language') == 'bangla' ? 'কার্টে যুক্ত করুন' : 'ADD TO CART' }}
                                                    </button>
                                                </div>
                            ...
                            <div class="col-sm-3">
                                <ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
                                    <li class="active"><a data-toggle="tab"
                                            href="#description">{{ session()->get('language') == 'bangla' ? 'বর্ণনা' : 'DESCRIPTION' }}</a>
                                    </li>
                                    <li><a data-toggle="tab"
                                            href="#review">{{ session()->get('language') == 'bangla' ? 'মতামত' : 'REVIEW' }}</a>
                                    </li>
